...
export default function AuthForm({ isLogin, onsubmit, credentialsInvalit }) {
  ...
  // console.log('pastwordDontMatc:'+pastwordDontMatc );
  // console.log('paswordIsInvalid:'+paswordIsInvalid);
  // console.log('emailDontMatc:'+emailDontMatc);
